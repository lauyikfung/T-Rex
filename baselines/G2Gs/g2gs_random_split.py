...
def main(args):
    ...
    if args['debug']:
        data_name = 'molecule-datasets/data_ChatGPT_debug.csv'
    else:
        data_name = 'molecule-datasets/data_ChatGPT.csv'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='data/molecule-datasets/')
