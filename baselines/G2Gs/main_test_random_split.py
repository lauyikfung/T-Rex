...
def main(args):
    ...
    reaction_metric = reaction_solver.evaluate("test")
    ...
    synthon_metric = synthon_solver.evaluate("test")
    ...
    f = open(os.path.join(args['save_dir'], 'retrosynthesis_result_test_new2.txt'), 'w')
